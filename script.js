...
const scenarios = [
    ...
    {
        id: 6,
        text: "🔦 It's bedtime! Parents turned off the Wi-Fi, but you want to sneak-play offline games. What do you do?",
        svgMarkup: `<svg viewBox="0 0 32 32" width="120" height="120"><path d="M22,24 C14.27,24 8,17.73 8,10 C8,7.9 8.46,5.92 9.28,4.12 C5.09,6.03 2,10.16 2,15 C2,21.63 7.37,27 14,27 C18.84,27 22.97,23.91 24.88,19.72 C23.08,20.54 21.1,21 19,21 Z" fill="#ffec99" stroke="#8c420e" stroke-width="2"/><rect x="24" y="6" width="2" height="2" fill="#ffd8a8"/><rect x="28" y="10" width="2" height="2" fill="#ffd8a8"/></svg>`,
        choices: [
            { text: "Play under the bedsheets anyway.", isCorrect: false, feedback: "❌ Alert! Sneak gaming breaks parent trust and ruins sleep. Keep bed-time for rest!" },
            { text: "Put the device away and go to sleep.", isCorrect: true, feedback: "🌙 Sweet dreams! Honest boundaries make you a hero and keep you refreshed." }
        ]
    },
    {
        id: 7,
...
// Presentation Slides Data (5 Presenters/Sections)
const presentationSlides = [
    {
        presenter: "🎤 Slide 1 of 5",
        title: "1. Introduction",
        bullets: [
            "🎮 Video games are popular among children today.",
            "✅ Games can improve creativity, teamwork, and problem-solving skills.",
            "❌ Excessive gaming can affect health, studies, and social relationships.",
            "⚠️ Gaming addiction means losing control over gaming and prioritising games over responsibilities.",
            "🎯 This courseware helps children aged 10–12:",
            "   • Understand the risks of excessive gaming.",
            "   • Recognise healthy and unhealthy gaming habits.",
            "   • Build responsible gaming behaviours.",
            "   • Develop a balanced digital lifestyle."
        ],
        highlight: {
            header: "🎯 INSTRUCTIONAL GOAL:",
            text: "Control the Game, Don't Let It Control You"
        }
    },
    {
        presenter: "🎤 Slide 2 of 5",
    ...
    {
        presenter: "🎤 Slide 3 of 5",
        title: "3. Learning Objectives",
        bullets: [
            "1️⃣ Understand gaming addiction and its signs",
            "2️⃣ Identify negative effects of excessive gaming",
            "3️⃣ Develop healthy gaming habits",
            "4️⃣ Apply techniques to control gaming",
            "5️⃣ Know when to seek help"
        ]
    },
    {
        presenter: "🎤 Slide 4 of 5",
        title: "4. Assessment Items",
        bullets: [
            "🎮 Platform: Healthy Habit Game (Web-Based Interactive Game)",
            "",
            "🎯 Activities:",
            "   • Habit Selection Activities",
            "   • Interactive Quizzes",
            "   • Scenario-Based Questions",
            "   • Game Challenges and Rewards",
            "",
            "🏆 Advantages:",
            "   • Interactive, enjoyable, and easy to use",
            "   • Increases student engagement",
            "   • Provides immediate feedback",
            "   • Improves understanding and memory",
            "   • Encourages positive and healthy habits"
        ]
    },
    {
        presenter: "🎤 Slide 5 of 5",
        title: "5. Conclusion",
        bullets: [
            "🎮 Gaming can be fun and educational.",
            "❌ Excessive gaming can negatively affect health, education, and relationships.",
            "✅ The Healthy Habit Game teaches responsible and balanced gaming habits.",
            "🤝 Parents, teachers, and communities play important roles in supporting healthy gaming habits."
        ],
        highlight: {
            header: "🎯 MAIN MESSAGE:",
            text: "\"Control the game, don't let the game control you.\" 🎮✨"
        }
    }
];
...
const slidePresenter = document.getElementById('slide-presenter');
const slideTitle = document.getElementById('slide-title');
const slideBody = document.getElementById('slide-body');
const slideQuestionBox = document.getElementById('slide-question-box');
const slideQuestionText = document.getElementById('slide-question-text');
...
// Presentation Functions & Handlers
function loadSlide(index) {
    ...
    // Update badge & title
    slidePresenter.textContent = slide.presenter;
    ...
    slide.bullets.forEach(bulletText => {
        ...
        p.className = 'slide-bullet';
        p.textContent = bulletText;
        slideBody.appendChild(p);
    });
    
    // Update highlight box
    if (slide.highlight) {
        slideQuestionBox.classList.remove('hidden');
        const headerEl = slideQuestionBox.querySelector('.question-header');
        if (headerEl) {
            headerEl.textContent = slide.highlight.header;
        }
        slideQuestionText.textContent = slide.highlight.text;
    } else {
        slideQuestionBox.classList.add('hidden');
    }
    ...
    if (index === presentationSlides.length - 1) {
        nextSlideBtn.textContent = "PLAY GAME ➜";
        nextSlideBtn.style.backgroundColor = 'var(--retro-green)';
        nextSlideBtn.style.borderColor = 'var(--retro-green-dark)';
        nextSlideBtn.style.boxShadow = '0 4px 0 var(--retro-green-dark)';
    } else {
        nextSlideBtn.textContent = "NEXT ▶";
        nextSlideBtn.style.backgroundColor = '';
        nextSlideBtn.style.borderColor = '';
        nextSlideBtn.style.boxShadow = '';
    }
}
